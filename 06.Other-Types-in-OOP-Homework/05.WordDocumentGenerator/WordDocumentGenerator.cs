namespace _05.WordDocumentGenerator
{
    ...
    public static class WordDocumentGenerator
    {
        public static void Main()
        {
            ...
            using (StreamReader sr = new StreamReader(@"..\..\assets\text.txt"))
            {
                Paragraph title = doc.InsertParagraph().Append(sr.ReadLine().Trim()).FontSize(35).Font(new FontFamily("Calibri"));
                title.Alignment = Alignment.center;
                title.Bold();

                Novacode.Image image = doc.AddImage(@"..\..\assets\rpg-game.png");
                ...
                p1.AppendLine(sr.ReadLine()).FontSize(12).Font(new FontFamily("Calibri"));
                p1.AppendLine(sr.ReadLine()).FontSize(12).Font(new FontFamily("Calibri"));
                p1.AppendLine(sr.ReadLine()).FontSize(12).Font(new FontFamily("Calibri"));
                ...
                p2.AppendLine(sr.ReadLine()).FontSize(12).Font(new FontFamily("Calibri"));

                Table table = doc.AddTable(4, 3);
                table.Design = TableDesign.LightListAccent1;
                table.Alignment = Alignment.center;
                string[] arr = Regex.Split(sr.ReadLine(), @"\s+");
                ...
                p3.AppendLine(sr.ReadLine()).FontSize(12).Font(new FontFamily("Calibri"));

                Paragraph footer1 = doc.InsertParagraph().Append(sr.ReadLine().Trim()).FontSize(20).Font(new FontFamily("Calibri"));
                footer1.Alignment = Alignment.center;
                temp = "SPECTACULAR";
                footer1.ReplaceText(temp, temp, false, RegexOptions.None, boldFFormat);

                Paragraph footer2 = doc.InsertParagraph().Append(sr.ReadLine().Trim()).FontSize(35).Font(new FontFamily("Calibri"));
